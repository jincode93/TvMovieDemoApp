...
final class ReviewViewController: UIViewController {
    ...
    private let collectionView: UICollectionView = {
        ...
        collectionView.register(ReviewHeaderCollectionViewCell.self,
                                forCellWithReuseIdentifier: ReviewHeaderCollectionViewCell.id)
        collectionView.register(ReviewCollectionViewCell.self,
                                forCellWithReuseIdentifier: ReviewCollectionViewCell.id)
    ...
    private func setUI() {
        ...
        collectionView.rx.itemSelected.bind { [weak self] indexPath in
            // sectionSnapshot.expend(headerItem)
            ...
            cellProvider: { collectionView, indexPath, item in
                ...
                case .header(let header):
                    let cell = collectionView.dequeueReusableCell(
                        withReuseIdentifier: ReviewHeaderCollectionViewCell.id,
                        for: indexPath
                    ) as? ReviewHeaderCollectionViewCell
                ...
                case .content(let content):
                    let cell = collectionView.dequeueReusableCell(
                        withReuseIdentifier: ReviewCollectionViewCell.id,
                        for: indexPath
